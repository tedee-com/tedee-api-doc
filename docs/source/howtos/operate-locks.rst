...
To operate a lock via API you need to be owner of the device or have active access with ``remoteAccessDisabled`` flag set to false (see :doc:`Access Details <../datastructures/access-details>`).
